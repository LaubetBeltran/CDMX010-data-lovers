import {weaknessesNumberFilterAdd, weaknessesNumberFilterQuit, pokemonTypeFilterAdd, pokemonTypeFilterQuit, buddyDistNumberFilterAdd, buddyDistFilterQuit} from '../src/filtros';
...
describe('pokemonTypeFilterAdd', () => {
    it('should return typeFilter fire', () => {
        expect(pokemonTypeFilterAdd(`fire`, 2)).toStrictEqual(["charmander", "charmeleon", "charizard", "vulpix", "ninetales", "growlithe", "arcanine", "ponyta", "rapidash", "magmar", "flareon", "moltres", "cyndaquil", "quilava", "typhlosion", "slugma", "magcargo", "houndour", "houndoom", "magby", "entei", "ho-oh"]);
    });
})

describe('weaknessesNumberFilterAdd', () => {
    it('should return typeFilter `fire` + weaknessesNumberFilter `3`', () => {
        expect(weaknessesNumberFilterAdd(3)).toStrictEqual(["charmander", "charmeleon", "charizard", "vulpix", "ninetales", "growlithe", "arcanine", "ponyta", "rapidash", "magmar", "flareon", "moltres", "cyndaquil", "quilava", "typhlosion", "slugma", "magby", "entei"]);
    });
});
...
describe('buddyDistNumberFilterAdd', () => {
    ...
    it ('should return typeFilter `fire` + weaknessesNumberFilter `3` + buddyFilter for buddy-distance-km =20', () => {
        expect(buddyDistNumberFilterAdd('20')).toStrictEqual(["moltres", "entei"])
    });
});
...
describe('pokemonBuddyFilterQuit', () => {
    ...
    it ('should return typeFilter `fire` + weaknessesNumberFilter `3` - buddyFilter for buddy-distance-km =20', () => {
        expect(buddyDistFilterQuit('')).toStrictEqual(["charmander", "charmeleon", "charizard", "vulpix", "ninetales", "growlithe", "arcanine", "ponyta", "rapidash", "magmar", "flareon", "moltres", "cyndaquil", "quilava", "typhlosion", "slugma", "magby", "entei"])
    });
})
...
describe('weaknessesNumberFilterQuit', () => {
    ...
    it('should return typefilter `fire` -weaknessesNumberFilter `3` + buddyFilter for buddy-distance-km =20', () => {
        expect(weaknessesNumberFilterQuit(3)).toStrictEqual(["moltres", "entei", "ho-oh"]);
    });
});

describe('weaknessesNumberFilterAdd', () => {
    it('should return typeFilter `fire` + weaknessesNumberFilter `3` + + buddyFilter for buddy-distance-km =20', () => {
        expect(weaknessesNumberFilterAdd(3)).toStrictEqual(["moltres", "entei"]);
    });
});


describe('pokemonTypeFilterQuit', () => {
    it('should resturn weaknessesNumberFilter `3` + buddyFilter for buddy-distance-km =20', ()=>{
        expect(pokemonTypeFilterQuit(2)).toStrictEqual(["moltres", "mewtwo", "mew", "entei"]);
    });
});